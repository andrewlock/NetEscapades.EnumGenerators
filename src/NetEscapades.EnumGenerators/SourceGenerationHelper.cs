    ...
    public static string GenerateExtensionClass(StringBuilder sb, in EnumToGenerate enumToGenerate)
    {
        ...
        sb.Append("""
            ...
            """
             ...
             value)
                        ...
                        {
            """);
        foreach (var (Key, Value) in enumToGenerate.Names)
        {
            sb.Append("""

                                
                """).Append(fullyQualifiedName).Append('.').Append(Key)
                .Append(" => ");

            if (Value.DisplayName is null)
            {
                sb.Append("nameof(").Append(fullyQualifiedName).Append('.').Append(Key).Append("),");
            }
            else
            {
                sb.Append('"').Append(Value.DisplayName).Append("""
                    ",
                    """);
            }
        }
        ...
        if (enumToGenerate.HasFlags)
        {
            sb.Append("""
                ...
                """
            ).Append(fullyQualifiedName).Append(" value, ").Append(fullyQualifiedName).Append("""
                 flag)
        ...
        sb.Append("""
            ...
            """
             ...
             value)
                        ...
                        {
            """);
        foreach (var (Key, _) in enumToGenerate.Names)
        {
            sb.Append("""
        ...
        if (enumToGenerate.IsDisplayAttributeUsed)
        {
            sb.Append("""
                            ...
                            if (allowMatchingMetadataAttribute)
                            {
                                ...
                                {
                """);
            foreach (var (_, Value) in enumToGenerate.Names)
            {
                if (Value.DisplayName is not null && Value.IsDisplayNameTheFirstPresence)
                {
                    sb.Append("""
                                            ...
                                            "
                        """
                    ).Append(Value.DisplayName).Append("""
                        " => true,
                        """);
                }
            }
        ...
        foreach (var (Key, _) in enumToGenerate.Names)
        {
            sb.Append("""
                                ...
                                nameof(
                """).Append(fullyQualifiedName).Append('.').Append(Key).Append(") => true,");
        }
            ...
            foreach (var (_, Value) in enumToGenerate.Names)
            {
                if (Value.DisplayName is not null && Value.IsDisplayNameTheFirstPresence)
                {
                    sb.Append("""
                        ...
                        ".AsSpan(), global::System.StringComparison.Ordinal) => true,
                        """);
                }
            }
        ...
        foreach (var (Key, _) in enumToGenerate.Names)
        {
            sb.Append("""
                                ...
                                ReadOnlySpan<char> current when current.Equals(nameof(
                """).Append(fullyQualifiedName).Append('.').Append(Key)
                ...
                if (Value.DisplayName is not null && Value.IsDisplayNameTheFirstPresence)
                {
                    sb.Append("""
                        ...
                        ", global::System.StringComparison.OrdinalIgnoreCase):
                                                value = 
                        """
                    ).Append(fullyQualifiedName).Append('.').Append(Key).Append("""
                        ;
                                                return true;
                        """);
                }
        ...
        foreach (var (Key, _) in enumToGenerate.Names)
        {
            sb.Append("""
                                ...
                                case ReadOnlySpan<char> current when current.Equals(nameof(
                """
            ).Append(fullyQualifiedName).Append('.').Append(Key).Append("""
                ).AsSpan(), global::System.StringComparison.OrdinalIgnoreCase):
                                    result = 
        ...
        sb.Append("""
                            ...
                            case ReadOnlySpan<char> current when 
            """
        ).Append(enumToGenerate.UnderlyingType).Append("""
