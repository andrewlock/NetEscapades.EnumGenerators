...
public class GetValuesAnalyzer : DiagnosticAnalyzer
{
    public const string DiagnosticId = "NEEG009";
    public static readonly DiagnosticDescriptor Rule = new(
#pragma warning disable RS2008 // Enable Analyzer Release Tracking
        id: DiagnosticId,
#pragma warning restore RS2008
        title: "Use generated GetValues() instead of Enum.GetValues()",
        messageFormat: "Use generated GetValues() instead of Enum.GetValues() for better performance on enum '{0}'",
        category: "Usage",
    ...
    private static void AnalyzeInvocation(SyntaxNodeAnalysisContext context, INamedTypeSymbol enumExtensionsAttr, ExternalEnumDictionary externalEnumTypes)
    {
        ...
        if (invocation.ArgumentList.Arguments.Count is not (0 or 1)
            ...
            || memberAccess.Name.Identifier.Text != nameof(Enum.GetValues))
        {
        ...
        // Verify this is the GetValues() method from System.Enum
        if (methodSymbol.Name != nameof(Enum.GetValues) ||
        ...
        // 1. Enum.GetValues(typeof(TEnum)) - has 1 parameter
        // 2. Enum.GetValues<TEnum>() - has 0 parameters, is generic
        if (methodSymbol is { IsGenericMethod: true, TypeArguments.Length: 1 })
        {
            // Pattern: Enum.GetValues<TEnum>()
        ...
        {
            // Pattern: Enum.GetValues(typeof(TEnum))
