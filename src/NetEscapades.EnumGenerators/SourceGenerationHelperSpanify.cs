...
public static class SourceGenerationHelperSpanify
{
...
{");
    ...
    ").Append(enumToGenerate.IsPublic ? "public" : "internal").Append(@" static partial class ").Append(enumToGenerate.Name).Append(@"
    {
       ...
       public static bool IsDefined(").Append(enumToGenerate.FullyQualifiedName).Append(@" value)
        ...
        public static bool IsDefined(string name, bool allowMatchingMetadataAttribute = false)
        {
        ...
        public static bool IsDefined(in ReadOnlySpan<char> name, bool allowMatchingMetadataAttribute = false)
        {
            var isDefinedInDisplayAttribute = false;
            if (allowMatchingMetadataAttribute)
            {
        ...
        public static bool TryParse(
            ...
            => ignoreCase ? TryParse(name, System.StringComparison.OrdinalIgnoreCase, out value, allowMatchingMetadataAttribute) : TryParse(name, System.StringComparison.Ordinal, out value, allowMatchingMetadataAttribute);
        ...
        public static bool TryParse(
            ...
            out ").Append(enumToGenerate.FullyQualifiedName).Append(@" value, 
            bool allowMatchingMetadataAttribute = false)
            => TryParse(name, System.StringComparison.Ordinal, out value, allowMatchingMetadataAttribute);");
