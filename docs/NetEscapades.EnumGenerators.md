...
Source File: /NetEscapades.EnumGenerators.source.md
...
## Contents
  ...
  * [Enabling automatic interception](#enabling-automatic-interception)
    * [Avoiding runtime dependencies](#avoiding-runtime-dependencies)
    * [Choosing the correct packages for your scenario](#choosing-the-correct-packages-for-your-scenario)<!-- endToc -->
